...
rename_schema = {
    ...
    'Q22': 'How many years of formal music theory training do you have?',
    'Q23': 'Do you have perfect (absolute) pitch?',
    'Q24': 'What informed your judgement (if anything) of how familiar were the melodies?',
    'Q25': 'What general strategy (if any) did you use to judge whether melodies had some notes that were more important than others?',
}
